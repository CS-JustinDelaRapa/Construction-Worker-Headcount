...
//const will just let a function to just read the value of our Diary class current value (context)
  ...
  static AdditionalManpower fromJson(Map<String, Object?> fromSQL) => AdditionalManpower(
   ...
   @override
  String toString() {
    return 'id: $id, fk: $fk, work: $work, type: $type, 1: $cbOne, 2: $cbTwo, 3: $cbThree, 4: $cbFour, 5: $cbFive, 6: $cbSix, 7: $cbSeven, 8: $cbEight, 9: $cbNine, 10: $cbTen';
  }      
}
