...
class StructuralItems {
  static const List<String> listEarthWorks = ['Soil Type:','Excavation:','Preferred Time:'];
  static const List<String> listFormWorks = ['Column','Beam','Slab'];
  static const List<String> listMasonryWorks = ['Exterior','Interior'];
  static const List<String> listReinforecedWorks = ['Footing','Columns','Beam','Slab'];
  static const List<String> listSteelReinforecedWorks = ['Footing','Column','Beam']; 
